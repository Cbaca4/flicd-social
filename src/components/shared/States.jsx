...
export function ErrorState({text='Something went wrong.'}){return <div className="card" style={{borderColor:'rgba(255,104,104,.35)'}}><strong style={{color:'#ffb1b1'}}>Unable to load</strong><p className="subtitle" style={{marginTop:5}}>{text}</p></div>}
